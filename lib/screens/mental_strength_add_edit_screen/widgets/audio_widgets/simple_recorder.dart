...
class _SimpleRecorderState extends State<SimpleRecorder> {
  ...
  Future<void> openTheRecorder() async {
    try {
      ...
      // Check current storage permission status and request if necessary
      ...
      // Check codec support and adjust if necessary
    ...
    //  logger.e("Error opening recorder: $e");
      await _showPermissionDialog("Error", "An error occurred while initializing the recorder. Please try again.");
    }
  }

// Updated dialog method to include an optional action for settings
